...
export class PDFWorker {
    static "__#55@#fakeWorkerId": number;
    static "__#55@#isWorkerDisabled": boolean;
    static "__#55@#workerPorts": any;
    /**
     * @param {PDFWorkerParameters} params - The worker initialization parameters.
     */
    ...
    static get "__#55@#mainThreadWorkerMessageHandler"(): any;
